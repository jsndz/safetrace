...
import { Settings, Moon, Clock, Download, Trash2, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen p-4 pt-8">
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-400 text-sm">Configure your tracking preferences</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="autoStop" className="block">
                ...
                <p className="text-sm text-slate-400 mb-3">Automatically stop tracking after inactivity</p>
              </label>
        ...
        <GlassCard>
          <div className="space-y-4">
            ...
            <div>
              <h3 className="font-medium text-white mb-3">Default Export Format</h3>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    {locationHistory.length} location{locationHistory.length !== 1 ? 's' : ''} stored locally
                  </p>
                </div>
                <button
              ...
              <div className="p-3 bg-slate-700/30 rounded-lg border border-slate-600/30">
                <p className="text-xs text-slate-400">
                  All location data is stored locally on your device and never sent to external servers. 
                  You have full control over your privacy and data.
                </p>
              </div>
            </div>
          </div>
